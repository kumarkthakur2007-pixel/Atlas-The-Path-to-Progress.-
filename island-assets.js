...
const ISLAND_ASSET_REGISTRY = {
  ...
  // Phase 2+: house_1, library_1, park_1, school_1, town_hall_1, temple_1,
  // harbor_1, airport_1, civilization_1 — plus animals/effects — all get
  // added here, each with its own render() function above. The engine,
  // renderer, and unlock logic never need to change.
};
